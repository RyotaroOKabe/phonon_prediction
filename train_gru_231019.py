...
#%%
max_iter = 200 #200
lmax = 3    #random.randint(1, 3) #2
mul = 21 #random.randint(3, 32) #4
nlayers = 4 #random.randint(1, 5) #2
r_max = 4 #random.randint(3, 6) #4
number_of_basis = 12 #random.randint(5, 20) #10
radial_layers = 1 #1
radial_neurons = 135 #random.randint(30, 150) #100
node_dim = 118
node_embed_dim = 12 #random.randint(4, 128) #32
input_dim = 118
...
idx_tr = list(range(len(data_dict)-sub))
idx_te = list(range(len(data_dict)))
